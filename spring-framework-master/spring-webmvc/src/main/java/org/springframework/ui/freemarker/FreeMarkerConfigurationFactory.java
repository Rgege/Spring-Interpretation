...
public class FreeMarkerConfigurationFactory {
	 ...
	 * @see Configuration#setAllSharedVariables
	 */
	 ...
	 * @see Configuration#setDefaultEncoding
	 ...
	 * @see Configuration#setDirectoryForTemplateLoading
